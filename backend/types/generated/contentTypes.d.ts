...
export interface ApiCustomizationRequestCustomizationRequest
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    color: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'#ff0000'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEventTypeEventType extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customization_requests: Schema.Attribute.Relation<
      'oneToMany',
      'api::customization-request.customization-request'
    >;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    items: Schema.Attribute.Component<'order.cart-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::customization-request.customization-request': ApiCustomizationRequestCustomizationRequest;
